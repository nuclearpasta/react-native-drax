import { useMemo, useCallback, ReactNode, MutableRefObject } from 'react';
...
export const useContent = ({
  ...
  nodeHandleRef: MutableRefObject<number>;
  measurementsRef: MutableRefObject<DraxViewMeasurements>;
}) => {
  ...
  const trackingStatus = useMemo(() => getTrackingStatus(), [getTrackingStatus]);

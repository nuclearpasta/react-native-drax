...
export const PanGestureDetector = memo(
    ({ id, children, longPressDelay, draggable }: PropsWithChildren<TPanGestureDetectorProps>) => {
        // Connect with Drax.
        const { handleGestureEvent, handleGestureStateChange } = useDraxContext();
        ...
        const gesture = useMemo(
            () =>
                ...
                Gesture.Pan()
                    ...
                    .maxPointers(1)
                    .runOnJS(true),
            [handleGestureStateChange, id, longPressDelay, draggable, handleGestureEvent]
        );

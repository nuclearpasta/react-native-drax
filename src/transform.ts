...
export const flattenStylesWithoutLayout = (
    styles: (StyleProps | StyleProp<ViewStyle> | StyleProp<AnimatedStyle<StyleProp<ViewStyle>>> | null)[]
...
export const getCombinedHoverStyle = (
    ...
    const hoverStyles: (StyleProps | StyleProp<ViewStyle> | StyleProp<AnimatedStyle<StyleProp<ViewStyle>>> | null)[] = [
        props?.style,
        dimensions,
        props?.hoverStyle,
    ];

...
[Live demo](https://nuclearpasta.com/react-native-drax/example/drag-handles) · [View source on GitHub](https://github.com/nuclearpasta/react-native-drax/blob/main/example/screens/drag-handles.tsx)

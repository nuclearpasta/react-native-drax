...
[Live demo](https://nuclearpasta.com/react-native-drax/example/reorderable-grid) · [View source on GitHub](https://github.com/nuclearpasta/react-native-drax/blob/main/example/screens/reorderable-grid.tsx)

```tsx title="example/screens/reorderable-grid.tsx"

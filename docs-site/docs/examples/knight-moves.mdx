...
[Live demo](https://nuclearpasta.com/react-native-drax/example/knight-moves) · [View source on GitHub](https://github.com/nuclearpasta/react-native-drax/blob/main/example/screens/knight-moves.tsx)

```tsx title="example/screens/knight-moves.tsx"

...
[▶️ Live demo](https://nuclearpasta.com/react-native-drax/example/knight-moves) · [💻 Source](https://github.com/nuclearpasta/react-native-drax/blob/main/example/screens/knight-moves.tsx)

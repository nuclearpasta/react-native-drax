...
[▶️ Live demo](https://nuclearpasta.com/react-native-drax/example/kanban-board) · [💻 Source](https://github.com/nuclearpasta/react-native-drax/blob/main/example/screens/kanban-board.tsx)

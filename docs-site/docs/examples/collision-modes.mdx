...
[Live demo](https://nuclearpasta.com/react-native-drax/example/collision-modes) · [View source on GitHub](https://github.com/nuclearpasta/react-native-drax/blob/main/example/screens/collision-modes.tsx)

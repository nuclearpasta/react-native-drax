...
[Live demo](https://nuclearpasta.com/react-native-drax/example/scrolling) · [View source on GitHub](https://github.com/nuclearpasta/react-native-drax/blob/main/example/screens/scrolling.tsx)

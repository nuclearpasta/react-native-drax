---
title: Roadmap
description: Planned features for react-native-drax including haptic feedback, sortable flex layout, collapsible items, and more.
keywords: [react-native-drax, roadmap, planned-features, drag-and-drop, haptic-feedback, sortable-flex]
sidebar_position: 99
---

...
Drax is a declarative drag-and-drop system for React Native, written in TypeScript. It is built to be flexible and powerful with the goal of supporting many use cases, while its stock components and default settings should support the most common scenarios with minimal configuration.
